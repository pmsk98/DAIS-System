...
os.environ['RLTRADER_BASE'] = 'C:\\Users\\user\\Desktop\\research\\reinforcement_stock\\rltrader-master\\quantylab\\rltrader'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ver', choices=['v1', 'v2', 'v3', 'v4','v5'], default='v2')
